...
from ...models.add_member_avatar_multipart_data import AddMemberAvatarMultipartData
...
def _get_kwargs(
    ...
    *,
    ...
    multipart_data: AddMemberAvatarMultipartData,
) -> Dict[str, Any]:
    url = "{}/members/{id}/avatar".format(client.base_url, id=id)
